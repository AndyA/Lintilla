...
sub boilerplate($) {
  ...
  return (
    ...
    share_stash => {
      ...
      variantPanel => 'light'
# api_key=> opt.api_key,
# twitterName=> opt.twitterName,
# redirect_uri=> opt.redirect_uri,
# panelOpen=> opt.panelOpen,
# panelDirection=> opt.panelDirection,
# image=> 'http://www.cjdaugherty.com/wp-content/uploads/2013/08/bbc-logo9.jpg',
    },
